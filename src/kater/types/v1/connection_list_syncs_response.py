...
__all__ = ["ConnectionListSyncsResponse", "ConnectionListSyncsResponseItem", "ConnectionListSyncsResponseItemEvent"]


class ConnectionListSyncsResponseItemEvent(BaseModel):
...
class ConnectionListSyncsResponseItem(BaseModel):
    ...
    events: Optional[List[ConnectionListSyncsResponseItemEvent]] = None
    """Sync event history"""
...
ConnectionListSyncsResponse: TypeAlias = List[ConnectionListSyncsResponseItem]
