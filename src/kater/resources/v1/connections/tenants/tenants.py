...
from .....types.v1.connections.tenant_retrieve_schema_response import TenantRetrieveSchemaResponse
    ...
    def retrieve_schema(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=TenantRetrieveSchemaResponse,
        )
