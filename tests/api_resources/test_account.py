...
class TestAccount:
    ...
    def test_method_get_status(self, client: Kater) -> None:
        ...
        assert_matches_type(AccountGetStatusResponse, account, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get_status(self, client: Kater) -> None:
        response = client.account.with_raw_response.get_status()
    ...
    def test_streaming_response_get_status(self, client: Kater) -> None:
        with client.account.with_streaming_response.get_status() as response:
...
class TestAsyncAccount:
    ...
    async def test_method_get_status(self, async_client: AsyncKater) -> None:
        account = await async_client.account.get_status()
        assert_matches_type(AccountGetStatusResponse, account, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_get_status(self, async_client: AsyncKater) -> None:
        response = await async_client.account.with_raw_response.get_status()
    ...
    async def test_streaming_response_get_status(self, async_client: AsyncKater) -> None:
        async with async_client.account.with_streaming_response.get_status() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
